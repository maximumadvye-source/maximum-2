      ...
      <div className="topbar" role="navigation" aria-label="شريط الحالة العلوي">
        <div className="topbar-inner">
          <div className="topbar-icons" aria-hidden="false">
            ...
            <a href="#contact" className="topbar-icon" aria-label="مبيعات">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 7h18M5 7v11a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7M9 7V5a3 3 0 0 1 6 0v2" stroke="#fff" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
            </a>
